...
export class EmployeesComponent implements OnInit, OnDestroy {
  ...
  private branchesSubscription: Subscription | undefined;
  ...
  ngOnInit() {
    this.branchesSubscription = this.sharedAPI.getBranches().subscribe((response: BranchData) => {
    ...
    this.employeesSubscription = this.sharedAPI.getEmployeesData().subscribe((response: EmployeesData) => {
      if (response.status == 'OK') {
